...
mkdir -p "${LOCAL_GITLAB_GHORG_DIR}"
cp "${SCRIPT_DIR}/configs/repo-filter-hook.sh" "${LOCAL_GITLAB_GHORG_DIR}/repo-filter-hook.sh"
chmod +x "${LOCAL_GITLAB_GHORG_DIR}/repo-filter-hook.sh"
