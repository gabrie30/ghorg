...
func TestGithubListWorkerCount(t *testing.T) {
	...
	t.Run("honors explicit limit", func(t *testing.T) {
		_ = os.Setenv("GHORG_GITHUB_REPO_LIST_CONCURRENCY", "3")
		t.Cleanup(func() { _ = os.Unsetenv("GHORG_GITHUB_REPO_LIST_CONCURRENCY") })
	...
	t.Run("invalid env behaves like unlimited", func(t *testing.T) {
		_ = os.Setenv("GHORG_GITHUB_REPO_LIST_CONCURRENCY", "nope")
		t.Cleanup(func() { _ = os.Unsetenv("GHORG_GITHUB_REPO_LIST_CONCURRENCY") })
	...
	t.Run("caps explicit value", func(t *testing.T) {
		_ = os.Setenv("GHORG_GITHUB_REPO_LIST_CONCURRENCY", "9999")
		t.Cleanup(func() { _ = os.Unsetenv("GHORG_GITHUB_REPO_LIST_CONCURRENCY") })
